...
def generate_launch_description():
    ...
    # ──────────────────────────────────────────────────────────────────────────
    # Camera Test Node (Color-only detection for calibration testing)
    # ──────────────────────────────────────────────────────────────────────────
    camera_test_node = Node(
        package='simpler_pick_place',
        executable='camera_test_node.py',
        name='camera_test_node',
        output='screen',
        parameters=[{'use_sim_time': True}],
    )

    # Delay camera test node until camera is ready
    delay_vision = TimerAction(
        period=8.0,
        actions=[camera_test_node],
    )
